...
class ComposedStorageTests(unittest.TestCase):

    def assertDecomposed(self, storage, expected):
        self.assertIsInstance(storage, ComposedStorage)
        i = 0
        width = 0
    ...
    def test_single(self):
        '''Test construction via ComposedStorage.single() class method.'''
        storage = ComposedStorage.single(123, 8)
        expected = (
            (123, 0, 8),
            )
    ...
    def test_basic_concat(self):
        ...
        ref0 = ComposedStorage.single(0, 7)
        ref1 = ComposedStorage.single(1, 3)
        ref2 = ComposedStorage.single(2, 13)
    ...
    def test_basic_slice(self):
        ...
        ref0 = ComposedStorage.single(0, 8)
    ...
    def test_slice_concat(self):
        ...
        ref0 = ComposedStorage.single(0, 8)
        ref1 = ComposedStorage.single(1, 8)
        ref2 = ComposedStorage.single(2, 8)
